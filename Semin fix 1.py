...
#------CODE STRUKTUR DATA BINARY SEARCH TREE (BST)------#
...
#------CODE VISUALISASI BST MENGGUNAKAN MATPLOTLIB------#
...
#------CODE ANTARMUKA PENGGUNA (UI) MENGGUNAKAN GRADIO------#
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    ...
    gr.Markdown("---")
    gr.Markdown("Visualisasi keseluruhan struktur data obat (BST) telah dibuat dan disimpan sebagai `obat.png` saat aplikasi dimulai (jika data tersedia).")
